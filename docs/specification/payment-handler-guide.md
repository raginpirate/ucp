...
| **platform_schema** | Platform discovery (`/.well-known/ucp`) | Declares the platform identity and how it supports this handler. Includes `spec` and `schema` URLs for implementers. |
